 ...
 *                  v15 10 July 2024 - all bugs fixed, decimal display sorted. Completed
...
//===============================================================================
 ...
 // uint8_t dec_len = 2;                          // Number of decimals to display
  bool pressed;                        // Logic to determine state of screen pressed
...
void Function_Select()
  { 
     //  if (digitalRead(Precision))     // Need to OR this with touch screen sensor
   if ((( y < 70) && ( x > 220 )) || (digitalRead(Precision)) ) 
   {
...
//  if (digitalRead(Precision))     // Need to replace this with touch screen sensor
  } 
void setup() 
  {
